...
- [x] 1. Implement type definitions and test infrastructure
  - [x] 1.1 Implement type definitions in `src/scanner/types.ps1`
  ...
  - [x] 1.2 Set up Pester 5.x test infrastructure in `tests/`
  ...
  - [x] 1.3 Write unit tests for type factories in `tests/unit/types.Tests.ps1`
...
- [x] 2. Implement scanner module
  - [x] 2.1 Implement `Resolve-RulePath` helper in `src/scanner/scan.ps1`
  ...
  - [x] 2.2 Implement `Get-FolderSize` helper in `src/scanner/scan.ps1`
  ...
  - [x] 2.3 Implement `Start-DriveScan` Quick mode in `src/scanner/scan.ps1`
  ...
  - [x] 2.4 Implement `Start-DriveScan` Deep mode in `src/scanner/scan.ps1`
    - Get drive info via `Get-PSDrive` for used/free bytes
  ...
  - [x]* 2.5 Write property tests for scanner in `tests/property/scan.Property.Tests.ps1`
  ...
  - [x]* 2.6 Write unit tests for scanner in `tests/unit/scan.Tests.ps1`
...
- [x] 4. Implement categorizer module
  - [x] 4.1 Implement `Initialize-Rules` in `src/scanner/categorize.ps1`
    - Import `types.ps1` at the top of the module
  ...
  - [x] 4.2 Implement `Get-ItemCategory` in `src/scanner/categorize.ps1`
  ...
  - [x] 4.3 Implement `Get-AllCategories` in `src/scanner/categorize.ps1`
    - Iterate over all items in `ScanResult.Items`
    - Call `Get-ItemCategory` for each item
    - Return array of `CategorizedItem` objects
    - _Requirements: 3.1_

  - [x]* 4.4 Write property tests for categorizer in `tests/property/categorize.Property.Tests.ps1`
  ...
  - [x]* 4.5 Write property tests for rules parsing in `tests/property/rules.Property.Tests.ps1`
  ...
  - [x]* 4.6 Write unit tests for categorizer in `tests/unit/categorize.Tests.ps1`
...
- [x] 6. Implement CLI module
  - [x] 6.1 Implement `Format-Size` and `Show-DriveStatus` in `src/ui/cli.ps1`
  ...
  - [x] 6.2 Implement `Show-ScanResults` and `Show-ErrorSummary` in `src/ui/cli.ps1`
  ...
  - [x] 6.3 Implement `Show-Progress` in `src/ui/cli.ps1`
  ...
  - [x] 6.4 Implement `Show-MainMenu` with full navigation in `src/ui/cli.ps1`
  ...
  - [x]* 6.5 Write property tests for formatting in `tests/property/format.Property.Tests.ps1`
  ...
  - [x]* 6.6 Write unit tests for CLI in `tests/unit/format.Tests.ps1`
...
- [x] 8. Refactor entry point and integration
  - [x] 8.1 Refactor `scripts/analyze.ps1` to use modular architecture
  ...
  - [x]* 8.2 Write integration tests in `tests/integration/full-scan.Tests.ps1`
  ...
  - [x]* 8.3 Write CLI integration tests in `tests/integration/cli-menu.Tests.ps1`
